/*
 * File used from https://github.com/wooorm/linked-list/
 * Could not use the repositry via npm because it requires the support
 * of ESM Modules, which is not yet supported in this project.
 */
