...
/*
 * Probably not needed, but would be still nice to have.
...
test('create Two Overlapping dwell Btns',() => {
  ...
  dwellBtnCenter2.domEl = 'center2';

  expect(verifyDwellBtns([dwellBtnCenter, dwellBtnCenter2])).toThrow(
    'Buttons are possibly overlapping, please choose new positions or sizes'
  );
});
